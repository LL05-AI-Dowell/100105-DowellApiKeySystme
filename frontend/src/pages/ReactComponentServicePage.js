...
const ReactComponentServicePage = () => {
  ...
  return (
    <div>
      ...
      <Box sx={{ display: "flex", bgcolor: "#edf2f3", minHeight: "100vh" }}>
        <Sidebar page="reactService" />
        <Box width="80%" pt={4} ml={4}>
          {service_data !== null ? (
            <DocumentationCards card="REACT COMPONENT" title="REACT COMPONENT" />
          ) : (
...
export default ReactComponentServicePage;
